...
if(_8("dojo-bidi")){
_15=_2("dijit.form.Select",_15,{_setDisplay:function(_2f){
this.inherited(arguments);
...
return function(evt){
if(!this._isLoaded){
this.loadDropDown(_7.hitch(this,_31,evt));
}else{
this.inherited(_31,arguments);
}
};
};
_15.prototype._onContainerKeydown=_30("_onContainerKeydown");
_15.prototype._onContainerKeypress=_30("_onContainerKeypress");
return _15;
});
