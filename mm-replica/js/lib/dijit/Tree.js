...
var _a6=this.domNode.scrollLeft;
this.focusChild(_a5);
this.domNode.scrollLeft=_a6;
},_onNodeMouseEnter:function(){
},_onNodeMouseLeave:function(){
},_onItemChange:function(_a7){
var _a8=this.model,_a9=_a8.getIdentity(_a7),_aa=this._itemNodesMap[_a9];
if(_aa){
var _ab=this.getLabel(_a7),_ac=this.getTooltip(_a7);
_1.forEach(_aa,function(_ad){
_ad.set({item:_a7,label:_ab,tooltip:_ac});
_ad._updateItemClasses(_a7);
});
}
},_onItemChildrenChange:function(_ae,_af){
var _b0=this.model,_b1=_b0.getIdentity(_ae),_b2=this._itemNodesMap[_b1];
if(_b2){
_1.forEach(_b2,function(_b3){
_b3.setChildItems(_af);
});
}
},_onItemDelete:function(_b4){
var _b5=this.model,_b6=_b5.getIdentity(_b4),_b7=this._itemNodesMap[_b6];
if(_b7){
_1.forEach(_b7,function(_b8){
this.dndController.removeTreeNode(_b8);
var _b9=_b8.getParent();
if(_b9){
_b9.removeChild(_b8);
}
_b8.destroyRecursive();
},this);
delete this._itemNodesMap[_b6];
}
},_initState:function(){
this._openedNodes={};
if(this.persist&&this.cookieName){
var _ba=_4(this.cookieName);
if(_ba){
_1.forEach(_ba.split(","),function(_bb){
this._openedNodes[_bb]=true;
},this);
}
}
},_state:function(_bc,_bd){
if(!this.persist){
return false;
}
var _be=_1.map(_bc.getTreePath(),function(_bf){
return this.model.getIdentity(_bf);
},this).join("/");
if(arguments.length===1){
return this._openedNodes[_be];
}else{
if(_bd){
this._openedNodes[_be]=true;
}else{
delete this._openedNodes[_be];
}
...
if(_c0){
_a.setMarginBox(this.domNode,_c0);
}
