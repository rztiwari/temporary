...
if(_1a.node!=this.cursorNode&&_1a.node!=this.hueCursorNode){
return;
}
_f.focus(_1a.node);
...
},_updateColor:function(_25){
var _26=this.PICKER_HUE_SELECTOR_H/2,_27=this.PICKER_SAT_SELECTOR_H/2,_28=this.PICKER_SAT_SELECTOR_W/2;
var _29=_5.style(this.hueCursorNode,"top")+_26,_2a=_5.style(this.cursorNode,"top")+_27,_2b=_5.style(this.cursorNode,"left")+_28,h=Math.round(360-(_29/this.PICKER_HUE_H*360)),col=_12.fromHsv(h,_2b/this.PICKER_SAT_VAL_W*100,100-(_2a/this.PICKER_SAT_VAL_H*100));
this._updateColorInputs(col);
this._updateValue(col,_25);
if(h!=this._hue){
this._setHue(h);
}
...
},_updateValue:function(col,_2d){
var hex=col.toHex();
this.value=this.valueNode.value=hex;
if(_2d&&(!this._timer||this.liveUpdate)){
this.onChange(hex);
}
},_updatePickerLocations:function(col){
var _2e=this.PICKER_HUE_SELECTOR_H/2,_2f=this.PICKER_SAT_SELECTOR_H/2,_30=this.PICKER_SAT_SELECTOR_W/2;
var hsv=col.toHsv(),_31=Math.round(this.PICKER_HUE_H-hsv.h/360*this.PICKER_HUE_H)-_2e,_32=Math.round(hsv.s/100*this.PICKER_SAT_VAL_W)-_30,_33=Math.round(this.PICKER_SAT_VAL_H-hsv.v/100*this.PICKER_SAT_VAL_H)-_2f;
if(this.animatePoint){
fx.slideTo({node:this.hueCursorNode,duration:this.slideDuration,top:_31,left:0}).play();
fx.slideTo({node:this.cursorNode,duration:this.slideDuration,top:_33,left:_32}).play();
}else{
_5.style(this.hueCursorNode,"top",_31+"px");
_5.style(this.cursorNode,{left:_32+"px",top:_33+"px"});
}
if(hsv.h!=this._hue){
this._setHue(hsv.h);
}
...
var _34=this.PICKER_HUE_SELECTOR_H/2;
var _35=evt.layerY||(evt.y-evt.target.getBoundingClientRect().top);
_35-=_34;
if(this.animatePoint){
fx.slideTo({node:this.hueCursorNode,duration:this.slideDuration,top:_35,left:0,onEnd:_3.hitch(this,function(){
this._updateColor(true);
_f.focus(this.hueCursorNode);
})}).play();
}else{
_5.style(this.hueCursorNode,"top",_35+"px");
this._updateColor(true);
}
},_setPoint:function(evt){
var _36=this.PICKER_SAT_SELECTOR_H/2;
var _37=this.PICKER_SAT_SELECTOR_W/2;
var _38=evt.layerY||(evt.y-evt.target.getBoundingClientRect().top);
_38-=_36;
var _39=evt.layerX||(evt.x-evt.target.getBoundingClientRect().left);
_39-=_37;
if(evt){
_f.focus(evt.target);
}
if(this.animatePoint){
fx.slideTo({node:this.cursorNode,duration:this.slideDuration,top:_38,left:_39,onEnd:_3.hitch(this,function(){
this._updateColor(true);
_f.focus(this.cursorNode);
})}).play();
}else{
_5.style(this.cursorNode,{left:_39+"px",top:_38+"px"});
this._updateColor(true);
}
